...
#include <triton/Dialect/XeGPU/IR/XeGPUOpsTypes.cpp.inc>
      >();
  addOperations<
#define GET_OP_LIST
...
#include <triton/Dialect/XeGPU/IR/XeGPUOpsAttrs.cpp.inc>
      >();
}
...
static void printShapeAndType(mlir::AsmPrinter &printer, llvm::ArrayRef<int64_t> shape, mlir::Type type) {
...
#include <triton/Dialect/XeGPU/IR/XeGPUOpsDialect.cpp.inc>
